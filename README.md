# ArknightsServer
这是一个明日方舟本地服务端,对应的客户端是CN 2.6.71,该服务端理论上支持多人游戏,但仅仅支持单IP登录，如果多人在同一公网IP下登录可能会覆盖其他人的secret导致他人同步SyncData时读取的最新登录人的账户数据,本仓库不提供将数据代理到本地的方法,请自行解决 
# 注意
我高考完了，志愿也填完了，现在重新投入开发，开发版本将从Android转向Windows

# 2.4.61老版本用户注意！
若您是从2.4.61版本的服务端迁移至2.6.71请注意，因新版用户数据文件与旧版有较大的差别，所以所有数据库中的用户数据需要清空！
